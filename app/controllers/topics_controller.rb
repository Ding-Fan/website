class TopicsController < ApplicationController
  ...
  def create
    if current_user.points < 5
      ...
      @user.tag_list = topic_params[:tags]
      @topic.save
    end
  end
