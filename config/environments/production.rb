Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: Figaro.env.MAIL_DOMAIN, protocol: 'https' }

  config.action_mailer.delivery_method   = Figaro.env.MAILER_PROVIDER.to_s
  mail_options = {
    ...
    authentication: Figaro.env.MAIL_AUTH,
    enable_starttls_auto: true
  }
  if Figaro.env.mailer_provider == 'postmark'
    config.action_mailer.postmark_settings = mail_options
  else
    config.action_mailer.smtp_settings = mail_options
  end
