  ...
  class Pipeline
    class MarkdownFilter < HTML::Pipeline::TextFilter
      ...
      class Render < Redcarpet::Render::HTML
        ...
        class << self
          def to_html(raw)
            @render ||= Redcarpet::Markdown.new(self.new(filter_html: true, no_styles: true, safe_links_only: true, with_toc_data: true, truehard_wrap: true), autolink: true, tables: true, fenced_code_blocks: true, disable_indented_code_blocks: false, strikethrough: true, superscript: true, underline: true)
            @render.render(raw)
          end
        end
