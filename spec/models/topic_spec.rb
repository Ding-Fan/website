...
describe Topic, type: :model do
  ...
  it 'should update after reply' do
    ...
    expect(topic.last_reply_user_username).to eq(reply.user.username)
  end
  ...
  it 'should log deleted user name when use destroy_by' do
    t = create(:topic)
    t.destroy_by(user)
    expect(t.who_deleted).to eq(user.username)
  ...
  describe '.update_last_reply' do
    it 'should work' do
      ...
      expect(t.last_reply_user_username).to eq r.user.username
    ...
    it 'should update with nil when have :force' do
      ...
      expect(t.last_reply_user_username).to be_nil
      expect(t.last_active_mark).not_to be_nil
    end
  end
